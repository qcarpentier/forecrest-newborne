...
var PAGES = [
  ...
  { group: { fr: "Comptabilité", en: "Accounting" }, items: [
    { tab: "accounting", label: "Comptabilité", file: "AccountingPage.jsx", desc: { fr: "Grand livre mensuel PCMN. Journal des écritures auto-générées. Bilan simplifié. Export print.", en: "Monthly PCMN ledger. Auto-generated journal entries. Simplified balance sheet. Print export." }, props: "costs, sals, cfg, debts, streams, totalRevenue, monthlyCosts, ebitda, isoc, netP, annVatC/D" },
