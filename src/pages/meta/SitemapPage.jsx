...
var PAGES = [
  ...
  { group: { fr: "Finance", en: "Finance" }, items: [
    ...
    { tab: "ratios", label: "Ratios", file: "finance/RatiosPage.jsx", desc: { fr: "Page minimale — sera refactorisée avec BFR (phase 2 roadmap).", en: "Minimal page — will be refactored with working capital (roadmap phase 2)." }, props: "cfg" },
  ...
  { group: { fr: "Dev uniquement", en: "Dev only" }, items: [
    ...
    { tab: "dev-tokens", label: "Design Tokens", file: "meta/DesignTokensPage.jsx", desc: { fr: "Variables CSS, couleurs, espacements, rayons.", en: "CSS variables, colors, spacing, radii." }, props: "" },
