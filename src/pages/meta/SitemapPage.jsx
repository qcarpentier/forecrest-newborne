...
var PAGES = [
  ...
  { group: { fr: "Finance", en: "Finance" }, items: [
    ...
    { tab: "opex", label: "Charges", file: "finance/OperatingCostsPage.jsx", desc: { fr: "Charges d'exploitation avec 12 catégories PCMN (dont charges variables % CA + €/transaction et paliers par nombre de clients). Auto-items. TVA par ligne.", en: "Operating costs with 12 PCMN categories (including variable % revenue + €/tx and tiered-by-clients costs). Auto-items. Per-line VAT." }, props: "costs, setCosts, cfg, totalRevenue, costCtx, debts, assets, sals, crowdfunding, chartPalette" },
