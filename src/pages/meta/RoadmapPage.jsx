...
var ROADMAP = [
  {
    ...
    items: [
      ...
      { id: "redesign_pact", label: { fr: "Refaire la page Pacte", en: "Redesign Pact page" }, desc: { fr: "Refonte de la page clauses du pacte avec un vrai éditeur de clauses, prévisualisation et export.", en: "Redesign pact clauses page with a real clause editor, preview and export." }, status: "todo", priority: "medium" },
