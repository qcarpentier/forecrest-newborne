...
var ROADMAP = [
  {
    phase: "0",
    title: { fr: "Refonte des pages existantes", en: "Existing pages redesign" },
    desc: { fr: "Moderniser les pages existantes pour une meilleure clarté et plus de contenu", en: "Modernize existing pages for better clarity and more content" },
    items: [
      { id: "redesign_overview", label: { fr: "Refaire la page Vue d'ensemble", en: "Redesign Overview page" }, desc: { fr: "Refonte complète de la page d'accueil : KPIs modernes, charts interactifs, navigation rapide vers les sections. L'actuelle est trop basique.", en: "Complete overhaul of the home page: modern KPIs, interactive charts, quick navigation. Current one is too basic." }, status: "todo", priority: "high" },
      { id: "redesign_balance", label: { fr: "Refaire la page Bilan", en: "Redesign Balance Sheet page" }, desc: { fr: "InsightCarousel, StackedBar, DataTable collapsible PCMN, plan de financement.", en: "InsightCarousel, StackedBar, collapsible PCMN DataTable, financing plan." }, status: "done", priority: "high" },
      { id: "redesign_income", label: { fr: "Refaire la page Résultat", en: "Redesign Income Statement page" }, desc: { fr: "DataTable P&L multi-années, StackedBar charges, cards variance, hypothèses avec impact.", en: "Multi-year P&L DataTable, cost StackedBar, variance cards, assumptions with impact." }, status: "done", priority: "high" },
      { id: "redesign_ratios", label: { fr: "Refaire la page Ratios", en: "Redesign Ratios page" }, desc: { fr: "Page minimale à transformer en véritable tableau de bord d'analyse financière avec BFR, fonds de roulement et indicateurs visuels.", en: "Minimal page to transform into a real financial analysis dashboard with working capital, net working capital and visual indicators." }, status: "todo", priority: "high" },
      { id: "redesign_sensitivity", label: { fr: "Refaire la page Sensibilité", en: "Redesign Sensitivity page" }, desc: { fr: "Améliorer le tornado chart, ajouter des scénarios, rendre l'analyse what-if plus intuitive.", en: "Improve tornado chart, add scenarios, make what-if analysis more intuitive." }, status: "todo", priority: "medium" },
      { id: "redesign_pact", label: { fr: "Refaire la page Pacte", en: "Redesign Pact page" }, desc: { fr: "Refonte de la page clauses du pacte avec un vrai éditeur de clauses, prévisualisation et export.", en: "Redesign pact clauses page with a real clause editor, preview and export." }, status: "done", priority: "medium" },
      { id: "redesign_captable_round", label: { fr: "Repasser la levée de fonds (Cap Table)", en: "Revisit fundraising (Cap Table)" }, desc: { fr: "Le simulateur de levée de fonds n'est pas assez abouti. Améliorer la dilution visuelle, les termes et la modélisation pre/post-money.", en: "The fundraising simulator is not polished enough. Improve visual dilution, terms and pre/post-money modeling." }, status: "todo", priority: "medium" },
      { id: "redesign_accounting_vat", label: { fr: "Comptabilité : TVA, Impôts & Affectation", en: "Accounting: VAT, Taxes & Allocation" }, desc: { fr: "3 onglets dédiés : TVA (calendrier trimestriel), Impôts (ISOC + versements anticipés), Affectation du résultat (réserve, dividendes, CCT 90).", en: "3 dedicated tabs: VAT (quarterly calendar), Taxes (ISOC + advance payments), Profit Allocation (reserve, dividends, CCT 90)." }, status: "done", priority: "medium" },
      { id: "opex_variable_revenue", label: { fr: "Charges variables (% CA + €/transaction)", en: "Variable costs (% revenue + €/transaction)" }, desc: { fr: "Nouveau type de charge proportionnelle au revenu ou au nombre de transactions. Idéal pour modéliser les frais Stripe / PSP sans recalcul manuel.", en: "New cost type proportional to revenue or transaction count. Ideal for Stripe/PSP fees without manual recalculation." }, status: "done", priority: "high" },
      { id: "opex_tiered_clients", label: { fr: "Charges par paliers (nombre de clients)", en: "Tiered costs (client count)" }, desc: { fr: "Charges step-function qui changent selon le nombre de clients actifs (infrastructure cloud, SaaS à seuils). Palier actif calculé automatiquement.", en: "Step-function costs that change based on active client count (cloud infra, tiered SaaS). Active tier auto-computed." }, status: "done", priority: "medium" },
      { id: "preset_marketplace", label: { fr: "Preset Marketplace (commission BtoC)", en: "Marketplace preset (commission BtoC)" }, desc: { fr: "Scénario pré-rempli pour un modèle à commission : commission 15/20%, churn 2%, CAC 8€, ramp-up 6 mois, frais Stripe, paliers infra. Chargeable via Dev Palette.", en: "Pre-filled scenario for a commission-based model: 15/20% commission, 2% churn, €8 CAC, 6-month ramp-up, Stripe fees, tiered infra. Loadable via Dev Palette." }, status: "done", priority: "medium" },
    ],
  },
  {
    phase: "1",
    title: { fr: "Analyse approfondie", en: "Advanced analysis" },
    desc: { fr: "Nouvelles pages d'analyse financière", en: "New financial analysis pages" },
    items: [
      { id: "page_bfr", label: { fr: "Page BFR (Besoin en Fonds de Roulement)", en: "WCR page (Working Capital Requirement)" }, desc: { fr: "Page dédiée au BFR avec DSO, DPO, DIO, cycle de conversion cash. Visualisation graphique de l'évolution.", en: "Dedicated WCR page with DSO, DPO, DIO, cash conversion cycle. Graphical evolution view." }, status: "todo", priority: "high" },
      { id: "page_fr", label: { fr: "Page Fonds de Roulement", en: "Net Working Capital page" }, desc: { fr: "FR = capitaux permanents − actifs immobilisés. Suivi de l'équilibre financier structurel avec alertes.", en: "NWC = permanent capital − fixed assets. Structural financial balance tracking with alerts." }, status: "todo", priority: "high" },
      { id: "page_tresorerie_nette", label: { fr: "Page Trésorerie nette", en: "Net Cash page" }, desc: { fr: "Trésorerie nette = FR − BFR. Tableau de bord de la santé financière à court terme.", en: "Net cash = NWC − WCR. Short-term financial health dashboard." }, status: "todo", priority: "medium" },
      { id: "budget_vs_actual", label: { fr: "Budget vs Réel", en: "Budget vs Actual" }, desc: { fr: "Saisie des montants réels mois par mois. Analyse des écarts par poste.", en: "Monthly actuals input. Variance analysis per line item." }, status: "todo", priority: "high" },
      { id: "scenario_comparison", label: { fr: "Comparaison de scénarios", en: "Scenario comparison" }, desc: { fr: "Vue côte à côte de 3 scénarios (optimiste, réaliste, pessimiste).", en: "Side-by-side view of 3 scenarios." }, status: "todo", priority: "medium" },
    ],
  },
  {
    phase: "2",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "frozen_columns", label: { fr: "Colonnes figées (DataTable)", en: "Frozen columns (DataTable)" }, desc: { fr: "Sur les tableaux larges (scrollable), figer checkbox + première colonne à gauche pendant le scroll horizontal. Approche split-layout (Airtable/Google Sheets) plutôt que position:sticky sur td. Shadow dynamique au scroll.", en: "On wide tables (scrollable), freeze checkbox + first column on horizontal scroll. Split-layout approach (Airtable/Google Sheets) rather than position:sticky on td. Dynamic scroll shadow." }, status: "todo", priority: "medium" },
  ...
  },
  {
    ...
    items: [
      ...
      /* ── Sharing system (inspired by Gamma, Notion, Figma, Linear) ── */
      { id: "share_modal", label: { fr: "Modale de partage", en: "Share modal" }, desc: { fr: "Modale à onglets (Partage / Paramètres) avec barre de recherche email, liste des accès, bouton copier le lien. Pattern Gamma/Notion.", en: "Tabbed modal (Sharing / Settings) with email search bar, access list, copy link button. Gamma/Notion pattern." }, status: "todo", priority: "high" },
      { id: "share_permissions", label: { fr: "Permissions par lien", en: "Link permissions" }, desc: { fr: "4 niveaux : Pas d'accès, Lecture seule, Commentaires, Édition. Granularité par invité et par lien public. Dropdown intuitif par contact.", en: "4 levels: No access, View only, Comment, Edit. Granularity per guest and per public link. Intuitive dropdown per contact." }, status: "todo", priority: "high" },
      { id: "share_invite_email", label: { fr: "Invitation par email", en: "Email invite" }, desc: { fr: "Saisie email avec autocomplétion des membres workspace. Envoi d'un email d'invitation avec lien direct vers le plan. Rôle attribué à l'invitation.", en: "Email input with workspace member autocomplete. Sends invite email with direct link to the plan. Role assigned at invite." }, status: "todo", priority: "high" },
      { id: "share_public_link", label: { fr: "Lien public configurable", en: "Configurable public link" }, desc: { fr: "Lien 'Anyone with the link' avec permission configurable (lecture/commentaire/édition). Activation/désactivation en un clic. URL courte copiable.", en: "Anyone with the link' URL with configurable permission (view/comment/edit). Toggle on/off. Short copyable URL." }, status: "todo", priority: "medium" },
      { id: "share_password", label: { fr: "Protection par mot de passe", en: "Password protection" }, desc: { fr: "Option de mot de passe sur les liens publics. Obligatoire pour les plans contenant des données sensibles (salaires, cap table).", en: "Optional password on public links. Required for plans containing sensitive data (salaries, cap table)." }, status: "todo", priority: "medium" },
      { id: "share_expiration", label: { fr: "Expiration des liens", en: "Link expiration" }, desc: { fr: "Date d'expiration configurable sur les liens de partage (24h, 7j, 30j, personnalisé). Révocation instantanée.", en: "Configurable expiration on share links (24h, 7d, 30d, custom). Instant revocation." }, status: "todo", priority: "low" },
      { id: "share_embed", label: { fr: "Code d'intégration (embed)", en: "Embed code" }, desc: { fr: "Snippet iframe copiable pour intégrer le plan sur un site externe. Dimensions configurables. Option plein écran.", en: "Copyable iframe snippet to embed the plan on an external site. Configurable dimensions. Fullscreen option." }, status: "todo", priority: "low" },
      { id: "share_analytics", label: { fr: "Analytiques de partage", en: "Share analytics" }, desc: { fr: "Qui a consulté le plan, quand, combien de temps. Nombre de vues par lien. Notifications au propriétaire lors de nouvelles vues.", en: "Who viewed the plan, when, for how long. View count per link. Notifications to owner on new views." }, status: "todo", priority: "low" },
      { id: "share_page_scope", label: { fr: "Partage par section", en: "Per-section sharing" }, desc: { fr: "Partager uniquement certaines pages du plan (ex. bilan + P&L pour le comptable, KPIs pour l'investisseur). Masquer les données sensibles.", en: "Share only specific plan sections (e.g. balance + P&L for accountant, KPIs for investor). Hide sensitive data." }, status: "todo", priority: "low" },
      { id: "comment_system", label: { fr: "Commentaires", en: "Comments" }, desc: { fr: "Annotations par champ/section. Thread de discussion porteur-comptable. Résolution de commentaires. Notifications email.", en: "Per-field/section annotations. Founder-accountant discussion threads. Comment resolution. Email notifications." }, status: "todo", priority: "medium" },
      { id: "audit_trail", label: { fr: "Historique des modifications", en: "Audit trail" }, desc: { fr: "Qui a modifié quoi et quand. Timeline visuelle. Restauration de versions. Obligatoire pour la validation comptable.", en: "Who changed what and when. Visual timeline. Version restore. Required for accounting validation." }, status: "todo", priority: "medium" },
      /* ── Multi-user collaboration ── */
      { id: "collab_system", label: { fr: "Système de collaboration multi-utilisateurs", en: "Multi-user collaboration system" }, desc: { fr: "Architecture complète de collaboration temps réel avec Supabase Realtime. Présence, curseurs, verrous et synchronisation des données entre utilisateurs connectés.", en: "Full real-time collaboration architecture with Supabase Realtime. Presence, cursors, locks and data sync between connected users." }, status: "done", priority: "high" },
      { id: "collab_presence", label: { fr: "Suivi de présence en temps réel", en: "Real-time presence tracking" }, desc: { fr: "Détection des utilisateurs connectés au même workspace avec statut en ligne, page active et dernière activité via Supabase Realtime Presence.", en: "Detection of users connected to the same workspace with online status, active page and last activity via Supabase Realtime Presence." }, status: "done", priority: "high" },
      { id: "collab_share_invite", label: { fr: "Partage et invitation de membres", en: "Share/invite workspace members" }, desc: { fr: "Invitation de membres au workspace par email avec attribution de rôle (propriétaire, éditeur, lecteur). Gestion des invitations en attente.", en: "Invite workspace members by email with role assignment (owner, editor, viewer). Pending invitation management." }, status: "done", priority: "high" },
      { id: "collab_join_page", label: { fr: "Page de rejoindre pour invités", en: "Join page for invited users" }, desc: { fr: "Page dédiée pour accepter une invitation workspace. Vérification du token, création de compte si nécessaire, redirection vers le workspace.", en: "Dedicated page to accept a workspace invitation. Token verification, account creation if needed, redirect to workspace." }, status: "done", priority: "high" },
      { id: "collab_team_settings", label: { fr: "Gestion d'équipe dans les paramètres", en: "Team management in settings" }, desc: { fr: "Section dédiée dans les paramètres pour gérer les membres du workspace : liste, rôles, suppression, invitations en attente.", en: "Dedicated settings section to manage workspace members: list, roles, removal, pending invitations." }, status: "done", priority: "high" },
      { id: "collab_element_locking", label: { fr: "Verrouillage d'éléments pour édition concurrente", en: "Element locking for concurrent editing" }, desc: { fr: "Système de verrous sur les éléments en cours d'édition pour éviter les conflits. Indicateur visuel de qui édite quoi, libération automatique.", en: "Lock system on elements being edited to prevent conflicts. Visual indicator of who is editing what, automatic release." }, status: "done", priority: "high" },
      { id: "collab_bar", label: { fr: "Barre de collaboration avec avatars", en: "Collaboration bar with avatars" }, desc: { fr: "Barre dans le header affichant les avatars des utilisateurs connectés au workspace en temps réel. Indicateur de page active par utilisateur.", en: "Header bar showing avatars of users connected to the workspace in real time. Active page indicator per user." }, status: "done", priority: "high" },
      { id: "collab_notifications", label: { fr: "Système de notifications basique", en: "Basic notifications system" }, desc: { fr: "Notifications in-app pour les événements collaboratifs : invitation reçue, membre rejoint, modification importante. Centre de notifications avec badge.", en: "In-app notifications for collaborative events: invitation received, member joined, important changes. Notification center with badge." }, status: "done", priority: "medium" },
      /* ── Dashboard & account improvements ── */
      { id: "dashboard_independent", label: { fr: "Adapter le dashboard pour les indépendants", en: "Adapt dashboard for independent workers" }, desc: { fr: "Mode comptabilité simplifiée pour indépendants (recettes/dépenses) vs comptabilité en partie double pour sociétés. Adaptation automatique selon la forme juridique.", en: "Simple accounting mode for independent workers (income/expenses) vs double-entry for companies. Automatic adaptation based on legal form." }, status: "todo", priority: "high" },
      { id: "signup_identity", label: { fr: "Formulaire d'inscription : prénom, nom, date de naissance", en: "Signup form: collect first name, last name, date of birth" }, desc: { fr: "Collecter les informations d'identité (prénom, nom, date de naissance) lors de l'inscription pour pré-remplir les paramètres du compte et le représentant légal.", en: "Collect identity information (first name, last name, date of birth) at signup to pre-fill account settings and legal representative." }, status: "todo", priority: "medium" },
      { id: "account_settings_prefill", label: { fr: "Paramètres compte : pré-remplir depuis l'inscription", en: "Account settings: pre-fill from signup data" }, desc: { fr: "Pré-remplir les champs du profil depuis les données d'inscription. Si le représentant légal = créateur du compte, skip les champs d'onboarding correspondants.", en: "Pre-fill profile fields from signup data. If legal rep = account creator, skip the corresponding onboarding fields." }, status: "todo", priority: "medium" },
      { id: "accountant_dashboard", label: { fr: "Vue dashboard spécifique comptable", en: "Accountant-specific dashboard view" }, desc: { fr: "Dashboard adapté pour les comptables : PCMN partout, validation par écriture, alertes fiscales, vue multi-clients, accès rapide aux exports.", en: "Accountant-tailored dashboard: PCMN everywhere, entry validation, fiscal alerts, multi-client view, quick export access." }, status: "todo", priority: "medium" },
      { id: "advisor_dashboard", label: { fr: "Vue dashboard spécifique accompagnateur", en: "Advisor-specific dashboard view" }, desc: { fr: "Dashboard adapté pour les accompagnateurs/incubateurs : vue portfolio de startups, KPIs agrégés, progression des plans, alertes de santé financière.", en: "Advisor/incubator-tailored dashboard: startup portfolio view, aggregated KPIs, plan progress, financial health alerts." }, status: "todo", priority: "low" },
      { id: "collab_email_edge_fn", label: { fr: "Invitations par email via Edge Function", en: "Email invitations via Edge Function" }, desc: { fr: "Envoi d'emails d'invitation via Supabase Edge Functions avec template HTML brandé, lien direct vers la page de rejoindre, et gestion des erreurs.", en: "Send invitation emails via Supabase Edge Functions with branded HTML template, direct link to join page, and error handling." }, status: "todo", priority: "low" },
      { id: "collab_workspace_switch", label: { fr: "Changement de workspace pour multi-workspaces", en: "Workspace switching for users in multiple workspaces" }, desc: { fr: "Sélecteur de workspace pour les utilisateurs membres de plusieurs workspaces. Switch rapide sans déconnexion, indicateur du workspace actif.", en: "Workspace selector for users who are members of multiple workspaces. Quick switch without logout, active workspace indicator." }, status: "todo", priority: "low" },
    ],
  },
  {
    phase: "7",
    ...
    items: [
      { id: "pdf_business_plan", label: { fr: "Business plan PDF", en: "Business plan PDF" }, desc: { fr: "Document complet pour le notaire/banque : executive summary, P&L, bilan, financement, KPIs. Conforme CSA. Sélection des sections à inclure.", en: "Complete document for notary/bank: exec summary, P&L, balance sheet, financing, KPIs. CSA compliant. Section picker." }, status: "todo", priority: "high" },
      ...
      { id: "export_powerpoint", label: { fr: "Export PowerPoint / Google Slides", en: "PowerPoint / Google Slides export" }, desc: { fr: "Slides financières exportables en .pptx ou directement vers Google Slides. KPIs, charts, cap table, timeline.", en: "Financial slides exportable as .pptx or directly to Google Slides. KPIs, charts, cap table, timeline." }, status: "todo", priority: "medium" },
      { id: "export_png", label: { fr: "Export images (PNG)", en: "Image export (PNG)" }, desc: { fr: "Export de sections individuelles en PNG haute résolution pour intégration dans des présentations ou documents externes.", en: "Export individual sections as high-resolution PNGs for use in external presentations or documents." }, status: "todo", priority: "low" },
      ...
      { id: "export_linkedin", label: { fr: "Partage LinkedIn direct", en: "Direct LinkedIn share" }, desc: { fr: "Publier un résumé du plan (KPIs, milestones) directement sur LinkedIn avec lien vers le plan partagé.", en: "Post a plan summary (KPIs, milestones) directly to LinkedIn with link to the shared plan." }, status: "todo", priority: "low" },
      { id: "print_qr_domain", label: { fr: "QR code print → forecrest.be", en: "Print QR code → forecrest.be" }, desc: { fr: "Remplacer le QR code temporaire (GitHub) dans les impressions par le domaine officiel forecrest.be une fois disponible.", en: "Replace the temporary QR code (GitHub) in print exports with the official forecrest.be domain once available." }, status: "todo", priority: "low" },
      { id: "tools_page", label: { fr: "Page Outils", en: "Tools Page" }, desc: { fr: "Suite d'outils pratiques pour entrepreneurs : générateur de QR code (9 types, thèmes, logo, historique), vérificateur de nom de domaine (15 TLDs, score qualité, comparateur registrars, watchlist).", en: "Practical toolkit for entrepreneurs: QR code generator (9 types, themes, logo, history), domain name checker (15 TLDs, quality score, registrar comparison, watchlist)." }, status: "done", priority: "medium" },
      { id: "publishing_domain", label: { fr: "Publication sur domaine personnalisé", en: "Custom domain publishing" }, desc: { fr: "Publier le plan sur un sous-domaine personnalisé (plan.monentreprise.be). Navigation intégrée, favicon custom, barre de nav avec logo.", en: "Publish the plan on a custom subdomain (plan.mycompany.be). Integrated nav, custom favicon, logo nav bar." }, status: "todo", priority: "low" },
    ],
  },
  {
    phase: "8",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "auto_crowd_revenue", label: { fr: "Crowdfunding → Revenus (campagne terminée)", en: "Crowdfunding → Revenue (completed campaign)" }, desc: { fr: "Montant levé intégré au CA quand la campagne est terminée. Modèle flexible (Indiegogo, GoFundMe) : fonds versés même si objectif non atteint. Fait.", en: "Raised amount included in revenue when campaign is completed. Flexible model (Indiegogo, GoFundMe): funds disbursed even if goal not reached. Done." }, status: "done", priority: "high" },
      { id: "auto_affiliation_revenue", label: { fr: "Affiliation → Revenus (commissions)", en: "Affiliation → Revenue (commissions)" }, desc: { fr: "Revenus mensuels d'affiliation intégrés au chiffre d'affaires total (×12). Fait.", en: "Monthly affiliation revenue included in total annual revenue (×12). Done." }, status: "done", priority: "high" },
