...
export default {
  ...
  credits: {
    ...
    usage_compression: "Compression des snapshots partagés",
  ...
  changelog: {
    ...
    // v0.2.2.1
    cl_pastebin_cors_fallback: "Correction : 0x0.st bloquait les uploads navigateur à cause de CORS (« Failed to fetch »). Le lien court essaie maintenant paste.rs en premier (CORS ouvert), puis 0x0.st en fallback. Référence stockée comme « provider:id » pour récupération fiable.",
    ...
    // v0.2.1.0
    cl_hidden_tabs: "Nouveau : cfg.hiddenTabs permet de masquer des onglets non pertinents pour le cas d'usage courant. Le preset Marketplace masque par défaut Salaires, Dette, Stocks, Production, Crowdfunding, Affiliation, Equity, Cap Table, Pacte, et tout le module Marketing. Sidebar et header header s'adaptent automatiquement. Pour réactiver un onglet : vider ou éditer le tableau dans cfg.",
    cl_overview_report_hidden: "Amélioration : bouton « Générer un rapport » masqué sur la Vue d'ensemble (code conservé pour réactivation ultérieure).",

    // v0.2.0.1
    cl_viewyear_default: "Correction : en mode Marketplace, Forecrest affiche désormais automatiquement l'Année 1 de la projection si aucune année n'est explicitement sélectionnée. Le bandeau de la Vue d'ensemble affiche les valeurs exactes utilisées (CA et EBITDA) pour dissiper toute ambiguïté.",
    ...
    // v0.1.46.0
    cl_viewer_share_qr: "Nouveau : partage en lecture seule par QR code — générez un lien figé scanné par n'importe qui pour visualiser votre business plan sans pouvoir le modifier.",
    cl_viewer_mode: "Nouveau : mode lecture seule — les liens partagés s'ouvrent dans un viewer qui désactive les modifications et n'écrit jamais en local.",
    cl_viewer_snapshot_compression: "Amélioration : compression pako (deflate) des snapshots partagés pour faire tenir un business plan complet dans un QR code.",
