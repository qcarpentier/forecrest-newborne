...
import { Button } from "@/src/components/untitled/base/base/buttons/button";
...
import { FeaturedIcon } from "@/src/components/untitled/base/foundations/featured-icon/featured-icon";
