...
export default function AuthWall() {
  ...
  return createPortal(
    <div style={{
      ...
      {/* Fake dashboard skeleton behind — hidden on mobile */}
      {isMobile ? null : (
        <div style={{
      ...
      <div style={{
        ...
        width: isMobile ? "100%" : 420, maxWidth: isMobile ? "100%" : "90vw",
        background: "var(--bg-card)",
        border: "1px solid var(--border)",
        borderRadius: "var(--r-xl)",
        boxShadow: "var(--shadow-modal)",
        padding: isMobile ? "var(--sp-6) var(--sp-4)" : "var(--sp-8)",
        textAlign: "center",
        margin: isMobile ? "var(--sp-4)" : 0,
      }}>
        {/* Logo */}
        <div style={{
