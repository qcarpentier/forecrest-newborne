  ...
  var NAV_GROUPS = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "ratios",        icon: Scales,          label: tb.ratios,                 keys: [] },
      ],
    },
    {
      label: sg.equity || "Equity",
      items: [
        { id: "equity",   icon: ChartPie,   label: s.nav_equity   || tb.equity,   keys: ["8"] },
        { id: "captable", icon: UsersThree,  label: s.nav_captable || tb.captable, keys: ["9"] },
